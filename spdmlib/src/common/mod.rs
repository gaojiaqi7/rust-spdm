...
impl<'a> SpdmContext<'a> {
    ...
    pub fn calc_req_transcript_hash(
        ...
        let message =
            self.calc_req_transcript_data(use_psk, slot_id, calc_mut_cert, message_k, message_f)?;
    ...
    pub fn calc_rsp_transcript_hash(
        ...
        let message_f = Some(&session.runtime_info.message_f);
        let message =
            self.calc_rsp_transcript_data(use_psk, slot_id, calc_mut_cert, message_k, message_f)?;
